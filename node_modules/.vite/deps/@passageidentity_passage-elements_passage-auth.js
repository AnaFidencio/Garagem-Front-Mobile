...
(function(module, exports) {
  (function(window2, undefined$1) {
    ...
    var rgxMapper = function(ua, arrays) {
      var i2 = 0, j2, k, p2, q2, matches, match;
...
var n$2 = (e2, r2, i2) => new Promise((t2, a) => {
  var u2 = (s) => {
    try {
      c2(i2.next(s));
    } catch (p2) {
  ...
  }, c2 = (s) => s.done ? t2(s.value) : Promise.resolve(s.value).then(u2, g2);
  c2((i2 = i2.apply(e2, r2)).next());
});
var C$1 = (e2, r2) => n$2(void 0, null, function* () {
  let i2, t2 = new Promise((a) => {
    i2 = setTimeout(a, r2);
  });
  return Promise.race([e2, t2]).then((a) => (clearTimeout(i2), a));
});
var o$1 = class {
  ...
  static decodeBytes(e2) {
    let r2 = e2.replace(/-/g, "+").replace(/_/g, "/"), i2 = P(r2);
    return Uint8Array.from(atob(i2), (t2) => t2.charCodeAt(0));
  }
};
var P = (e2) => {
  let r2 = e2.indexOf("=");
...
var y$1 = class {
  static parsePublicKey(r2) {
    if (r2.challenge = o$1.decodeBytes(r2.challenge.toString()), r2.allowCredentials) {
      for (let i2 = 0; i2 < r2.allowCredentials.length; i2++) {
        let t2 = r2.allowCredentials[i2];
        t2.id = o$1.decodeBytes(t2.id.toString());
      }
      return r2;
    }
  ...
  static getCredential(r2, i2) {
    return n$2(this, null, function* () {
      return yield navigator.credentials.get({ mediation: i2 == null ? void 0 : i2.mediation, signal: i2 == null ? void 0 : i2.signal, publicKey: this.parsePublicKey(r2) }).then((a) => a).catch((a) => (console.info(a), null));
    });
  }
  static getCredentialAvailable() {
    return n$2(this, null, function* () {
      let r2 = { securityKey: false, platform: false, syncedCredential: false, crossDeviceCredential: false, conditionalUI: false, isAvailable: false }, i2 = yield d.createCredentialAvailable();
      if (r2.securityKey = i2.securityKey, r2.platform = i2.platform, r2.isAvailable = i2.isAvailable, !r2.securityKey)
        return r2;
    ...
    return n$2(this, null, function* () {
      if (window.PublicKeyCredential) {
        ...
        if (r2.getClientCapabilities) {
          let i2 = yield r2.getClientCapabilities();
          return { securityKey: true, platform: i2.userVerifyingPlatformAuthenticator, syncedCredential: i2.passkeyPlatformAuthenticator, crossDeviceCredential: i2.hybridTransport, conditionalUI: i2.conditionalMediation, isAvailable: true };
        }
      }
    });
  }
...
var r = "undefined" != typeof window && window.atob && window.atob.bind(window) || function(r2) {
  ...
  for (var n2, o2, a = 0, i2 = 0, c2 = ""; o2 = t2.charAt(i2++); ~o2 && (n2 = a % 4 ? 64 * n2 + o2 : o2, a++ % 4) ? c2 += String.fromCharCode(255 & n2 >> (-2 * a & 6)) : 0)
...
var Semaphore = function() {
  ...
  Semaphore2.prototype.acquire = function(weight) {
    ...
    return new Promise(function(resolve2, reject) {
      ...
      _this._weightedQueues[weight - 1].push({ resolve: resolve2, reject });
      _this._dispatch();
    });
  };
  ...
  Semaphore2.prototype.waitForUnlock = function(weight) {
    ...
    return new Promise(function(resolve2) {
      ...
      _this._weightedWaiters[weight - 1].push(resolve2);
      _this._dispatch();
    });
  };
...
var y = class {
  psgCredIDExists(e2) {
    let r2 = e2.user.id, o2 = e2.handshake.challenge.publicKey.allowCredentials, s = this.getPsgCredObj();
    if (!s)
      throw new u("Could not get psg_cred_obj", { status: g.PSGCredObjectDoesNotExist, statusText: "PSG Cred Object Does Not Exist" });
    let h2 = JSON.parse(s)[r2];
    return h2 ? o2.find((P2) => {
      if (c.encodeBytes(c.decodeBytes(P2.id)) === c.encodeBytes(c.decodeBytes(h2)))
        return true;
    }) : false;
  }
  setPsgCredID(e2, r2) {
    if (!r2)
      throw new u("Could not get user's credential", { status: g.PSGCouldNotGetUserCredential, statusText: "PSG Could Not Get User Credential" });
    let o2 = this.getPsgCredObj();
    if (o2) {
      let s = JSON.parse(o2);
      s[e2] = r2 == null ? void 0 : r2.id, this.setPsgCredObj(JSON.stringify(s));
    } else
      this.setPsgCredObj(JSON.stringify({ [e2]: r2 == null ? void 0 : r2.id }));
  }
  removeCredential(e2) {
    let r2 = this.getPsgCredObj();
    if (r2 === void 0)
      return;
    let o2 = JSON.parse(r2);
    Object.keys(o2).forEach((s) => {
      o2[s] === e2 && delete o2[s];
    }), this.setPsgCredObj(JSON.stringify(o2));
  }
  getPsgCredObj() {
    let e2 = api.get("psg_cred_obj"), r2 = localStorage.getItem("psg_cred_obj");
    if (e2 !== void 0)
      return api.set("psg_cred_obj", e2, { expires: 400, sameSite: "Strict" }), r2 === null && localStorage.setItem("psg_cred_obj", e2), e2;
    if (r2 !== null)
      return api.set("psg_cred_obj", r2, { expires: 400, sameSite: "Strict" }), r2;
  }
  setPsgCredObj(e2) {
...
function n(t2) {
  var s;
  let e2 = new Headers(t2), r2 = f.version, o2 = f.EXTRA_HEADERS;
  if (e2.append("Passage-Version", r2), o2) {
    let h2 = ((s = o2.find((a) => a.hasOwnProperty("elementVersion"))) == null ? void 0 : s.elementVersion) || null;
    h2 && e2.append("Passage-Element-Version", h2);
  }
  return e2;
}
var B = class {
...
var N = class extends G {
  ...
  setAuthToken(r2) {
    ...
    let o2 = !this._isHttps() && this._isLocalHost();
    return document.cookie = `psg_auth_token = ${r2}; path=/ ${o2 ? "" : ";secure"}`, Promise.resolve();
  }
  getRefreshToken() {
...
function S(t2, e2) {
  return $(t2) ? (b(e2) && e2.setTokens(t2.auth_result), t2) : (console.warn("Not a valid auth response"), t2);
}
var K = new y();
var O = class {
  constructor(e2, r2, o2) {
    this.tokenStore = r2;
    this.apiUrl = e2 + "/register/", this.identifier = o2;
  }
  withWebAuthn(e2) {
    return __async(this, null, function* () {
      var m2;
      let r2 = yield fetch(this.apiUrl + "webauthn/start", { headers: n(), body: JSON.stringify({ identifier: this.identifier, authenticator_attachment: (m2 = e2 == null ? void 0 : e2.authenticatorAttachment) != null ? m2 : T.Platform }), method: "POST" }).then(i), o2 = r2.handshake.challenge.publicKey, { credential: s, transports: h2 } = yield d.createCredential(o2).catch((k) => {
...
var C = class {
  constructor(e2, r2, o2) {
    this.tokenStore = r2;
    this.apiUrl = e2 + "/login/", this.identifier = o2 != null ? o2 : "";
  }
  withWebAuthn(e2) {
    return __async(this, null, function* () {
      let r2 = JSON.stringify({ identifier: this.identifier }), o2 = this.identifier ? r2 : void 0, s = yield fetch(this.apiUrl + "webauthn/start", { headers: n(), method: "POST", body: o2 }).then(i), h2 = s.handshake.challenge.publicKey, a = yield y$1.getCredential(h2, e2).catch((_) => {
        throw new u("error parsing public key for webAuthn", { status: g.PSGParsePublicKeyForLoginFailed, statusText: "PSG Parse Public Key For Login Failed" });
      });
...
var v = class {
  ...
  appInfo() {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl, { headers: n(), method: "GET" }).then(i)).app;
    });
  }
  identifierExists(e2) {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl + "/users?identifier=" + encodeURIComponent(e2), { headers: n(), method: "GET" }).then(i)).user;
    });
  }
};
var w = class {
  ...
  newRegister(e2, r2) {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl + "/register/magic-link", { headers: n(), method: "POST", body: JSON.stringify({ identifier: e2, magic_link_path: window.location.pathname + window.location.search + window.location.hash, language: r2 }) }).then(i)).magic_link;
    });
  }
  newLogin(e2, r2) {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl + "/login/magic-link", { headers: n(), method: "POST", body: JSON.stringify({ identifier: e2, magic_link_path: window.location.pathname + window.location.search + window.location.hash, language: r2 }) }).then(i)).magic_link;
    });
  }
  getStatus(e2) {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl + "/magic-link/status", { headers: n(), method: "POST", body: JSON.stringify({ id: e2 }) }).then(i).then((o2) => S(o2, this.tokenStore))).auth_result;
    });
  }
  activate(e2) {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl + "/magic-link/activate", { headers: n(), method: "PATCH", body: JSON.stringify({ magic_link: e2 }) }).then(i).then((o2) => S(o2, this.tokenStore))).auth_result;
    });
  }
  _parsePublicKeyLogin(e2) {
    if (e2.challenge = c.decodeBytes(e2.challenge.toString()), e2.allowCredentials) {
      for (let r2 = 0; r2 < e2.allowCredentials.length; r2++) {
        let o2 = e2.allowCredentials[r2];
        o2.id = c.decodeBytes(o2.id.toString());
      }
      return e2;
    }
    return e2;
...
var R = class {
  ...
  newRegister(e2, r2) {
    return __async(this, null, function* () {
      return yield fetch(this.apiUrl + "/register/otp", { headers: n(), method: "POST", body: JSON.stringify({ identifier: e2, language: r2 }) }).then(i);
    });
  }
  newLogin(e2, r2) {
    return __async(this, null, function* () {
      return yield fetch(this.apiUrl + "/login/otp", { headers: n(), method: "POST", body: JSON.stringify({ identifier: e2, language: r2 }) }).then(i);
    });
  }
  activate(e2, r2) {
    return __async(this, null, function* () {
      return (yield fetch(this.apiUrl + "/otp/activate", { headers: n(), method: "POST", body: JSON.stringify({ otp: e2, otp_id: r2 }) }).then(i).then((s) => S(s, this.tokenStore))).auth_result;
    });
  }
};
var Y = ((o2) => (o2.ACTIVE = "active", o2.INACTIVE = "inactive", o2.PENDING = "pending", o2))(Y || {});
var H = ((o2) => (o2.Platform = "platform", o2.Passkey = "passkey", o2.SecurityKey = "security_key", o2))(H || {});
function E(t2) {
  return `${f.URL}/v1/apps/${t2}`;
}
var A = class {
  constructor(e2, r2) {
    this.tokenStore = r2;
  ...
  authGuard() {
    return __async(this, null, function* () {
      try {
        let e2 = yield this.tokenStore.getAuthToken(), r2 = o(e2, { header: true }), o$12 = o(e2);
        return !!(o$12 !== void 0 && r2 !== void 0 && this._validJWTPayload(o$12) && this._validJWTHeader(r2));
      } catch (e2) {
        return false;
      }
    });
  ...
  signOut() {
    return __async(this, null, function* () {
      ...
      return e2 ? fetch(`${this.apiUrl}?` + new URLSearchParams({ refresh_token: e2 }), { method: "DELETE" }).then(({ status: r2 }) => r2 === 200).finally(() => {
        b(this.tokenStore) && this.tokenStore.clearTokens();
      }) : (b(this.tokenStore) && this.tokenStore.clearTokens(), true);
    });
  }
  getAuthToken() {
    return __async(this, null, function* () {
      let e2 = yield this._getMutex("getAuthToken").acquire(), r2 = yield this.tokenStore.getAuthToken();
      if ((yield this.tokenStore.getRefreshToken()) === void 0) {
        if (!r2)
          throw e2(), new u("Login required", { status: g.PSGLoginRequired, statusText: "Login required" });
        return e2(), r2;
      }
      if (r2) {
        let s = o(r2);
        if (s !== void 0 && this._validJWTPayload(s))
          return e2(), Promise.resolve(r2);
      }
  ...
  refresh() {
    return __async(this, null, function* () {
      let e2 = yield this._getMutex("refresh").acquire(), r2 = new u("Login required", { status: g.PSGLoginRequired, statusText: "Login required" }), o2 = yield this.tokenStore.getRefreshToken();
      return o2 ? fetch(this.apiUrl, { headers: n(), method: "POST", body: JSON.stringify({ refresh_token: o2 }) }).then(i).then((s) => (b(this.tokenStore) && this.tokenStore.setTokens(s.auth_result), s.auth_result)).catch(() => {
        throw r2;
      }).finally(() => {
        e2();
  ...
  _validJWTPayload(e2) {
    let o2 = Math.floor(Date.now() / 1e3);
    return !(e2.exp && o2 > e2.exp);
  }
  _validJWTHeader(e2) {
...
var I = class {
  ...
  userInfo() {
    return __async(this, null, function* () {
      let e2 = yield this._getToken(), r2 = yield fetch(this.apiUrl, { method: "GET", headers: n({ Authorization: `Bearer ${e2}` }) }).then((o2) => __async(this, null, function* () {
        return o2.status !== 200 ? void 0 : yield o2.json();
      })).catch((o2) => {
  ...
  changeEmail(e2, r2) {
    return __async(this, null, function* () {
      let o2 = yield this._getToken();
      return (yield fetch(`${this.apiUrl}/email`, { method: "PATCH", headers: n({ Authorization: `Bearer ${o2}`, "Content-Type": "application/json" }), body: JSON.stringify({ new_email: e2, language: r2 }) }).then(i)).magic_link;
    });
  }
  changePhone(e2, r2) {
    return __async(this, null, function* () {
      let o2 = yield this._getToken();
      return (yield fetch(`${this.apiUrl}/phone`, { method: "PATCH", headers: n({ Authorization: `Bearer ${o2}`, "Content-Type": "application/json" }), body: JSON.stringify({ new_phone: e2, language: r2 }) }).then(i)).magic_link;
    });
  }
  editDevice(e2, r2) {
    return __async(this, null, function* () {
      if (e2 === "" || e2 === void 0)
        throw new u("A deviceID is required for an edit device request.", { status: g.BadRequest, statusText: "Bad Request" });
      if (Object.keys(r2).length === 0)
        throw new u("Edit device request must not have an empty request body.", { status: g.BadRequest, statusText: "Bad Request" });
      let o2 = yield this._getToken();
      return (yield fetch(`${this.apiUrl}/devices/${e2}`, { method: "PATCH", headers: n({ Authorization: `Bearer ${o2}`, "Content-Type": "application/json" }), body: JSON.stringify(__spreadValues({}, r2)) }).then(i)).device;
    });
  }
  listDevices() {
    return __async(this, null, function* () {
      let e2 = yield this._getToken();
      return (yield fetch(`${this.apiUrl}/devices/`, { method: "GET", headers: n({ Authorization: `Bearer ${e2}`, "Content-Type": "application/json" }) }).then(i)).devices;
    });
  }
  addDevice(e2) {
    return __async(this, null, function* () {
      var _;
      let r2 = yield this._getToken(), o2 = yield fetch(this.apiUrl + "/devices/start", { headers: n({ Authorization: `Bearer ${r2}` }), body: JSON.stringify({ authenticator_attachment: (_ = e2 == null ? void 0 : e2.authenticatorAttachment) != null ? _ : T.Platform }), method: "POST" }).then(i), s = yield navigator.credentials.create({ publicKey: this._parsePublicKey(o2.handshake.challenge.publicKey) }).catch((m2) => {
      ...
      (s == null ? void 0 : s.response.getTransports) && typeof (s == null ? void 0 : s.response.getTransports) == "function" && (h2 = s == null ? void 0 : s.response.getTransports());
      let a = o2.user.id, P2 = yield fetch(this.apiUrl + "/devices/finish", { headers: n({ Authorization: `Bearer ${r2}` }), method: "POST", body: JSON.stringify({ user_id: a, handshake_id: o2.handshake.id, handshake_response: { rawId: c.encodeBytes(s == null ? void 0 : s.rawId), id: s == null ? void 0 : s.id, type: s == null ? void 0 : s.type, response: { attestationObject: c.encodeBytes(s == null ? void 0 : s.response.attestationObject), clientDataJSON: c.encodeBytes(s == null ? void 0 : s.response.clientDataJSON) }, transports: h2 } }) }).then(i);
      return D.setPsgCredID(a, s), P2.device;
    });
  }
  deleteDevice(e2) {
    return __async(this, null, function* () {
      let r2 = typeof e2 == "string" ? e2 : e2.id, o2 = typeof e2 == "string" ? void 0 : e2.cred_id;
      if (!r2)
        throw new u("A deviceID is required to delete a device.", { status: g.NotFound, statusText: "Not Found" });
      let s = false, h2 = yield this._getToken();
      return s = yield fetch(`${this.apiUrl}/devices/${r2}`, { method: "DELETE", headers: n({ Authorization: `Bearer ${h2}`, "Content-Type": "application/json" }) }).then((a) => __async(this, null, function* () {
        return a.ok ? true : yield a.text().then((P2) => {
          throw new u(P2, a);
        });
      })), s && o2 !== void 0 && D.removeCredential(o2), s;
    });
  }
  listSocialConnections() {
    return __async(this, null, function* () {
      let e2 = yield this._getToken();
      return (yield fetch(`${this.apiUrl}/social-connections/`, { method: "GET", headers: n({ Authorization: `Bearer ${e2}`, "Content-Type": "application/json" }) }).then(i)).social_connections;
    });
  }
  deleteSocialConnection(e2) {
    return __async(this, null, function* () {
      let r2 = false, o2 = yield this._getToken();
      return r2 = yield fetch(`${this.apiUrl}/social-connections/${e2}`, { method: "DELETE", headers: n({ Authorization: `Bearer ${o2}`, "Content-Type": "application/json" }) }).then((s) => __async(this, null, function* () {
        return s.ok ? true : yield s.text().then((h2) => {
          throw new u(h2, s);
        });
      })), r2;
    });
  ...
  getMetadata() {
    return __async(this, null, function* () {
      let e2 = yield this._getToken();
      return (yield fetch(`${this.apiUrl}/user-metadata`, { method: "GET", headers: n({ Authorization: `Bearer ${e2}` }) }).then(i)).user_metadata;
    });
  }
  updateMetadata(e2) {
    return __async(this, null, function* () {
      let r2 = yield this._getToken();
      return (yield fetch(`${this.apiUrl}/user-metadata`, { method: "PATCH", headers: n({ Authorization: `Bearer ${r2}`, "Content-Type": "application/json" }), body: JSON.stringify({ user_metadata: e2 }) }).then(i)).user;
    });
  }
  _parsePublicKey(e2) {
    return e2.challenge = c.decodeBytes(e2.challenge.toString()), e2.user.id = c.decodeBytes(e2.user.id.toString()), e2;
...
var x = class {
  ...
  authorizeWith(e2) {
    return __async(this, null, function* () {
      if (!window.isSecureContext)
        throw new u("Passage Social Login requires a secure context (HTTPS or localhost)", { status: g.PSGSecureContextRequired, statusText: "Secure context required" });
      sessionStorage.setItem("oauth2Connection", e2);
      let r2 = yield this._getQueryParams(e2);
  ...
  exchangeToken(e2) {
    return __async(this, null, function* () {
      ...
      if (r2 === null || r2 === "" || r2 === " ")
        throw new u("Social login verifier not found", { status: g.PSGSocialSessionStorageError, statusText: "Social login verifier not found" });
      let o2 = `${this.apiUrl}/token?code=${e2}&verifier=${r2}`;
      return (yield fetch(o2, { headers: n(), method: "GET" }).then(i).then((h2) => S(h2, this.tokenStore))).auth_result;
    });
  }
  _getQueryParams(e2) {
    return __async(this, null, function* () {
      let r2 = window.location.href, o2 = this._getRandomString(32);
      sessionStorage.setItem("oauth2State", o2);
      let s = yield this._getCodeChallenge(), a = { redirect_uri: r2, state: o2, code_challenge: s, code_challenge_method: "S256", connection_type: e2 };
  ...
  _getCodeChallenge() {
    return __async(this, null, function* () {
      ...
      return sessionStorage.setItem("oauth2Verifier", e2), yield this._sha256Hash(e2);
    });
  }
  _getRandomString(e2) {
  ...
  _sha256Hash(e2) {
    return __async(this, null, function* () {
      let o2 = new TextEncoder().encode(e2), s = yield window.crypto.subtle.digest("SHA-256", o2);
...
var F = class {
  constructor(e2, r2) {
    this.appID = e2;
    this.fullUrl = E(this.appID), (r2 == null ? void 0 : r2.tokenStore) === void 0 ? this.tokenStore = new N() : this.tokenStore = r2.tokenStore, this.extraHeaders = r2 == null ? void 0 : r2.extraHeaders, f.EXTRA_HEADERS = this.extraHeaders;
  }
  credIDExists(e2) {
    let r2 = new y().getPsgCredObj();
    return r2 ? !!JSON.parse(r2)[e2] : false;
  }
  register(e2, r2) {
    return __async(this, null, function* () {
      return yield new O(this.fullUrl, this.tokenStore, e2).withWebAuthn(r2);
    });
  }
  login(e2) {
    return __async(this, null, function* () {
      return yield new C(this.fullUrl, this.tokenStore, e2).withWebAuthn();
    });
  }
  loginConditional(e2) {
    return __async(this, null, function* () {
      return yield new C(this.fullUrl, this.tokenStore).withWebAuthn({ mediation: "conditional", signal: e2 });
    });
  }
  appInfo() {
    return __async(this, null, function* () {
  ...
  browserInfo() {
    return __async(this, null, function* () {
      return yield new U().getBrowserInfo();
    });
  }
  ...
  createCredentialAvailable() {
    return __async(this, null, function* () {
      return yield d.createCredentialAvailable();
    });
  }
  ...
  isWebauthnSupported(e2) {
    return __async(this, null, function* () {
      let r2 = yield d.createCredentialAvailable();
      return e2 ? r2.securityKey : r2.platform;
    });
  }
  identifierExists(e2) {
    return __async(this, null, function* () {
      let o2 = yield new v(this.fullUrl).identifierExists(e2);
      return o2 && (o2.hasPasskey = o2.webauthn_types.includes("passkey"), o2);
    });
  }
  newRegisterMagicLink(e2, r2) {
    return __async(this, null, function* () {
      return yield new w(this.fullUrl, this.tokenStore).newRegister(e2, r2);
    });
  }
  newLoginMagicLink(e2, r2) {
    return __async(this, null, function* () {
      return yield new w(this.fullUrl, this.tokenStore).newLogin(e2, r2);
    });
  }
  magicLinkActivate(e2) {
    return __async(this, null, function* () {
      return yield new w(this.fullUrl, this.tokenStore).activate(e2);
    });
  }
  getMagicLinkStatus(e2) {
    return __async(this, null, function* () {
      return yield new w(this.fullUrl, this.tokenStore).getStatus(e2);
    });
  }
  newRegisterOneTimePasscode(e2, r2) {
    return __async(this, null, function* () {
      return yield new R(this.fullUrl, this.tokenStore).newRegister(e2, r2);
    });
  }
  newLoginOneTimePasscode(e2, r2) {
    return __async(this, null, function* () {
      return yield new R(this.fullUrl, this.tokenStore).newLogin(e2, r2);
    });
  }
  oneTimePasscodeActivate(e2, r2) {
    return __async(this, null, function* () {
      return yield new R(this.fullUrl, this.tokenStore).activate(e2, r2);
    });
  }
  getCurrentUser() {
  ...
  createUser(e2) {
    return __async(this, null, function* () {
      return (yield fetch(`${this.fullUrl}/users`, { headers: n(), body: JSON.stringify(__spreadValues({}, e2)), method: "POST" }).then(i)).user;
    });
  }
  authorizeWith(e2) {
    return __async(this, null, function* () {
      yield new x(this.fullUrl, this.tokenStore).authorizeWith(e2);
    });
  }
  finishSocialAuthentication(e2) {
    return __async(this, null, function* () {
      return yield new x(this.fullUrl, this.tokenStore).exchangeToken(e2);
    });
  }
};
var te = ((o2) => (o2.email = "email", o2.phone = "phone", o2.both = "both", o2))(te || {});
...
var se = ((o2) => (o2.LoginCode = "otp", o2.MagicLink = "magic_link", o2.None = "none", o2))(se || {});
var ne = ((o2) => (o2.Google = "google", o2.Github = "github", o2.Apple = "apple", o2))(ne || {});
...
function createPassageInstance(appId, tokenStore) {
  const elementVersion = "1.21.6";
  const passage = new F(appId, {
    tokenStore,
...
(function(module, exports) {
  !function(t2, e2) {
    ...
    var t2 = 1e3, e2 = 6e4, n2 = 36e5, r2 = "millisecond", i2 = "second", s = "minute", u2 = "hour", a = "day", o2 = "week", c2 = "month", f2 = "quarter", h2 = "year", d2 = "date", l2 = "Invalid Date", $2 = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y2 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
    ...
    var _ = function() {
      ...
      return m3.parse = function(t3) {
        ...
        if ($3 === o2)
          return y3(7);
        var M3 = (d3 = {}, d3[s] = e2, d3[u2] = n2, d3[i2] = t2, d3)[$3] || 1, m4 = this.$d.getTime() + r3 * M3;
        return b2.w(m4, this);
    ...
    return O2.prototype = k, [["$ms", r2], ["$s", i2], ["$m", s], ["$H", u2], ["$W", a], ["$M", c2], ["$y", h2], ["$D", d2]].forEach(function(t3) {
      k[t3[1]] = function(e3) {
...
var email = "data:image/svg+xml;base64,";
...
var phone = "data:image/svg+xml;base64,";
...
var close = "data:image/svg+xml;base64,";
...
var securityKey = "data:image/svg+xml;base64,";
var pencil = "data:image/svg+xml;base64,";
var google = "data:image/svg+xml;base64,";
var githubLight = "data:image/svg+xml;base64,";
var githubDark = "data:image/svg+xml;base64,";
var appleLight = "data:image/svg+xml;base64,";
var appleDark = "data:image/svg+xml;base64,";
var Icons = {
  appleBiometric,
  windowsHello,
  genericBiometrics,
  ...
  methods: {
    getSvgAttrs(svgEl) {
      ...
      for (let i2 = attrs.length - 1; i2 >= 0; i2--) {
        svgAttrs[attrs[i2].name] = attrs[i2].value;
      }
      return svgAttrs;
    },
    getSvgContent(svgEl) {
...
var Theme = ((Theme2) => {
  Theme2["Light"] = "light-theme";
  Theme2["Dark"] = "dark-theme";
  return Theme2;
})(Theme || {});
var themeSymbol = Symbol();
function useThemeSetup(props) {
  const currentTheme = ref("light-theme");
  provide(themeSymbol, readonly(currentTheme));
  ...
  window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", computeTheme);
  onBeforeUnmount(() => {
    window.matchMedia("(prefers-color-scheme: dark)").removeEventListener("change", computeTheme);
  });
  watch(
    () => props.theme,
    () => {
...
function useTheme() {
  ...
  if (currentTheme === void 0) {
    throw new Error("Theme instance not found");
  }
    ...
    return function() {
      ...
      var forEachProp = function forEachProp2(obj, callback) {
        ...
        for (var i22 = 0; i22 < keys.length; i22++) {
          callback(keys[i22], obj[keys[i22]]);
        }
      };
      ...
      var Iti = function() {
        ...
        _createClass(Iti2, [{
          ...
          value: function _addCountryCode(iso2, countryCode, priority) {
            ...
            for (var i22 = 0; i22 < this.countryCodes[countryCode].length; i22++) {
              if (this.countryCodes[countryCode][i22] === iso2)
                return;
            }
          ...
          value: function _translateCountriesByLocale() {
            for (var i22 = 0; i22 < this.countries.length; i22++) {
              var iso = this.countries[i22].iso2.toLowerCase();
              if (this.options.localizedCountries.hasOwnProperty(iso)) {
                this.countries[i22].name = this.options.localizedCountries[iso];
              }
            }
          }
        }, {
          key: "_countryNameSort",
          value: function _countryNameSort(a, b2) {
          ...
          value: function _processPreferredCountries() {
            ...
            for (var i22 = 0; i22 < this.options.preferredCountries.length; i22++) {
              var countryCode = this.options.preferredCountries[i22].toLowerCase();
          ...
          value: function _generateMarkup() {
            ...
            if (this.options.hiddenInput) {
              ...
              if (name) {
                var i22 = name.lastIndexOf("[");
                if (i22 !== -1)
                  hiddenInputName = "".concat(name.substr(0, i22), "[").concat(hiddenInputName, "]");
              }
          ...
          value: function _appendListItems(countries, className, preferred) {
            var tmp = "";
            for (var i22 = 0; i22 < countries.length; i22++) {
              var c22 = countries[i22];
          ...
          value: function _searchForCountry(query) {
            for (var i22 = 0; i22 < this.countries.length; i22++) {
              if (this._startsWith(this.countries[i22].name, query)) {
                var listItem = this.countryList.querySelector("#iti-".concat(this.id, "__item-").concat(this.countries[i22].iso2));
          ...
          key: "_startsWith",
          value: function _startsWith(a, b2) {
            return a.substr(0, b2.length).toLowerCase() === b2;
          }
        }, {
          ...
          value: function _getCountryData(countryCode, ignoreOnlyCountriesOption, allowFail) {
            ...
            for (var i22 = 0; i22 < countryList.length; i22++) {
              if (countryList[i22].iso2 === countryCode) {
                return countryList[i22];
              }
            }
            if (allowFail) {
              return null;
          ...
          value: function _getDialCode(number2, includeAreaCode) {
            ...
            if (number2.charAt(0) === "+") {
              var numericChars = "";
              for (var i22 = 0; i22 < number2.length; i22++) {
                var c22 = number2.charAt(i22);
                if (!isNaN(parseInt(c22, 10))) {
                  numericChars += c22;
                  if (includeAreaCode) {
                    if (this.countryCodes[numericChars]) {
                      dialCode = number2.substr(0, i22 + 1);
                    }
                  } else {
...
var Utils = class _Utils {
  ...
  static isIntercepted(a, b2) {
    return !(a.y >= b2.y + b2.h || a.y + a.h <= b2.y || a.x + a.w <= b2.x || a.x >= b2.x + b2.w);
  }
  static isTouching(a, b2) {
    return _Utils.isIntercepted(a, { x: b2.x - 0.5, y: b2.y - 0.5, w: b2.w + 1, h: b2.h + 1 });
  }
  static sort(nodes, dir, column) {
    column = column || nodes.reduce((col, n2) => Math.max(n2.x + n2.w, col), 0) || 12;
    if (dir === -1)
      return nodes.sort((a, b2) => b2.x + b2.y * column - (a.x + a.y * column));
    else
      return nodes.sort((b2, a) => b2.x + b2.y * column - (a.x + a.y * column));
  }
  ...
  static copyPos(a, b2, minMax = false) {
    a.x = b2.x;
    a.y = b2.y;
    a.w = b2.w;
    a.h = b2.h;
  ...
  static samePos(a, b2) {
    return a && b2 && a.x === b2.x && a.y === b2.y && a.w === b2.w && a.h === b2.h;
  }
  static removeInternalAndSame(a, b2) {
    if (typeof a !== "object" || typeof b2 !== "object")
      return;
    for (let key in a) {
      let val = a[key];
      if (key[0] === "_" || val === b2[key]) {
        delete a[key];
      } else if (val && typeof val === "object" && b2[key] !== void 0) {
        for (let i2 in val) {
          if (val[i2] === b2[key][i2] || i2[0] === "_") {
            delete val[i2];
          }
        }
...
var GridStackEngine = class _GridStackEngine {
  ...
  swap(a, b2) {
    ...
    function _doSwap() {
      ...
      a._dirty = b2._dirty = true;
      return true;
    }
    let touching;
    if (a.w === b2.w && a.h === b2.h && (a.x === b2.x || a.y === b2.y) && (touching = utils_1.Utils.isTouching(a, b2)))
      return _doSwap();
    if (touching === false)
      return;
    if (a.w === b2.w && a.x === b2.x && (touching || (touching = utils_1.Utils.isTouching(a, b2)))) {
      if (b2.y < a.y) {
        let t2 = a;
        a = b2;
        b2 = t2;
    ...
    if (touching === false)
      return;
    if (a.h === b2.h && a.y === b2.y && (touching || (touching = utils_1.Utils.isTouching(a, b2)))) {
      if (b2.x < a.x) {
        let t2 = a;
        a = b2;
        b2 = t2;
  ...
  _packNodes() {
    ...
    if (this.float) {
      ...
      this.nodes.forEach((n2, i2) => {
        if (n2.locked)
          return;
        while (n2.y > 0) {
          let newY = i2 === 0 ? 0 : n2.y - 1;
          let canBeMoved = i2 === 0 || !this.collide(n2, { x: n2.x, y: newY, w: n2.w, h: n2.h });
          if (!canBeMoved)
            break;
          n2._dirty = n2.y !== newY;
          n2.y = newY;
  ...
  addNode(node, triggerAddEvent = false) {
    ...
    if (node.autoPosition) {
      this._sortNodes();
      for (let i2 = 0; ; ++i2) {
        let x2 = i2 % this.column;
        let y2 = Math.floor(i2 / this.column);
  ...
  save(saveElement = true) {
    ...
    this._sortNodes();
    this.nodes.forEach((n2) => {
      let wl = layout === null || layout === void 0 ? void 0 : layout.find((l2) => l2._id === n2._id);
    ...
    this._layouts.forEach((layout, column) => {
      ...
      if (column < this.column) {
        ...
        nodes.forEach((node) => {
          if (!node._orig)
            return;
          let n2 = layout.find((l2) => l2._id === node._id);
          if (!n2)
            return;
  ...
  cacheLayout(nodes, column, clear2 = false) {
    ...
    nodes.forEach((n2, i2) => {
      ...
      copy[i2] = { x: n2.x, y: n2.y, w: n2.w, _id: n2._id };
    });
  ...
  cacheOneLayout(n2, column) {
    ...
    let index = this._layouts[column].findIndex((l2) => l2._id === n2._id);
  ...
  class GridStack {
    constructor(el, opts = {}) {
      ...
      if (this.opts.auto) {
        ...
        elements.sort((a, b2) => a.i - b2.i).forEach((e2) => this._prepareElement(e2.el));
        this.commit();
      }
    ...
    update(els, opt) {
      if (arguments.length > 2) {
        ...
        let a = arguments, i2 = 1;
        opt = { x: a[i2++], y: a[i2++], w: a[i2++], h: a[i2++] };
      ...
      GridStack.getElements(els).forEach((el) => {
        ...
        let keys = ["x", "y", "w", "h"];
        let m2;
        if (keys.some((k) => w2[k] !== void 0 && w2[k] !== n2[k])) {
          m2 = {};
          keys.forEach((k) => {
            m2[k] = w2[k] !== void 0 ? w2[k] : n2[k];
            delete w2[k];
          });
        }
    ...
    willItFit(node) {
      if (arguments.length > 1) {
        ...
        let a = arguments, i2 = 0, w2 = { x: a[i2++], y: a[i2++], w: a[i2++], h: a[i2++], autoPosition: a[i2++] };
    ...
    _updateStyles(forceUpdate = false, maxH) {
      ...
      if (maxH > this._styles._max) {
        ...
        for (let i2 = this._styles._max + 1; i2 <= maxH; i2++) {
          let h2 = getHeight(i2);
          utils_12.Utils.addCSSRule(this._styles, `${prefix}[gs-y="${i2 - 1}"]`, `top: ${getHeight(i2 - 1)}`);
          utils_12.Utils.addCSSRule(this._styles, `${prefix}[gs-h="${i2}"]`, `height: ${h2}`);
          utils_12.Utils.addCSSRule(this._styles, `${prefix}[gs-min-h="${i2}"]`, `min-height: ${h2}`);
          utils_12.Utils.addCSSRule(this._styles, `${prefix}[gs-max-h="${i2}"]`, `max-height: ${h2}`);
        }
...
function transformMetadata(metadata, schema, defaultBooleans = false) {
  ...
  schema.forEach((schema2) => {
    ...
    if (schema2.type === oe.DATE && metadataValue) {
      transformedMetadata[schema2.field_name] = dayjs(metadataValue).format("YYYY-MM-DD");
    }
    if (defaultBooleans && schema2.type === oe.BOOLEAN && metadataValue === void 0) {
      transformedMetadata[schema2.field_name] = false;
    }
  });
  return transformedMetadata;
}
var socialConnectionMetadata = {
  github: {
    icons: {
  ...
  apple: {
    icons: {
      light: Icons.appleLight,
      dark: Icons.appleDark
    },
...
var _withScopeId = (n2) => (pushScopeId("data-v-a9054ff0"), n2 = n2(), popScopeId(), n2);
var _hoisted_1$w = { class: "identifier-form" };
var _hoisted_2$l = { class: "has-text-centered" };
var _hoisted_3$h = _withScopeId(() => createBaseVNode("br", null, null, -1));
var _hoisted_4$g = { class: "identifier-text" };
var _hoisted_5$f = ["autocomplete", "inputmode", "placeholder"];
var _hoisted_6$d = { class: "flex-row flex-center" };
var _hoisted_7$b = {
  key: 0,
...
var _sfc_main$A = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const inputMode = computed(() => {
      if (props.identifierMode === te.phone) {
        return "tel";
      }
      return "email";
    });
    ...
    function validateInput() {
      if (formattedIdentifier() === "") {
        ...
        return false;
      } else if (props.identifierMode === te.email && !isEmail2()) {
        identifierParseError.value = t2("enter-a-valid-email-address");
        return false;
      } else if (props.identifierMode === te.phone && !isPhoneNumber()) {
        identifierParseError.value = t2("enter-a-valid-phone-number");
        return false;
      } else if (props.identifierMode === te.both && !isPhoneNumber() && !isEmail2()) {
    ...
    if (props.identifierMode === te.both) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$w, [
        withDirectives(createBaseVNode("div", _hoisted_2$l, [
          ...
          _hoisted_3$h,
          createBaseVNode("strong", _hoisted_4$g, toDisplayString$1(identifierText.value), 1)
        ], 512), [
        ...
        createBaseVNode("div", _hoisted_6$d, [
          ...
          }, toDisplayString$1(unref(t2)("continue")), 513)
        ]),
        showWelcomeUI.value ? (openBlock(), createElementBlock("div", _hoisted_7$b, [
          createBaseVNode("a", {
            onClick: withModifiers(switchAccount, ["prevent"]),
            role: "button",
            class: "body-link",
            "data-testid": "register-link"
          }, toDisplayString$1(unref(t2)("switch-account")), 1)
        ])) : createCommentVNode("", true)
      ]);
    };
  }
});
var ValidatedIdentifierForm = _export_sfc(_sfc_main$A, [["__scopeId", "data-v-a9054ff0"]]);
...
var BeforeAuthCallbackType = ((BeforeAuthCallbackType2) => {
  BeforeAuthCallbackType2["Login"] = "login";
  BeforeAuthCallbackType2["Register"] = "register";
  return BeforeAuthCallbackType2;
})(BeforeAuthCallbackType || {});
...
function loginUserEventHandler(payload, eventHandlerState, passage) {
  return __async2(this, null, function* () {
    ...
    const userHasPasskey = webauthnTypes.includes(H.Passkey);
    const userHasPlatform = webauthnTypes.includes(H.Platform);
    const userHasSecurityKey = webauthnTypes.includes(H.SecurityKey);
...
function finishLinkingAccount(passage) {
  return __async2(this, null, function* () {
    ...
    yield passage.getCurrentUser().linkSocialAccount(code2);
  });
}
...
function socialAuthEventHandler(eventHandlerState, passage) {
  return __async2(this, null, function* () {
    ...
    if (code2 === null || linkAccount === null || identifier2 === null) {
      emitEvent2({ type: AuthEventType.ChangeIdentifier, payload: void 0 });
      return;
    }
    eventHandlerState.authState.socialLogin = true;
    if (linkAccount === "true") {
      eventHandlerState.router.push(LinkAccountRoute, { identifier: identifier2, code: code2 });
      return;
    }
    try {
      const authResult = yield passage.finishSocialAuthentication(code2);
...
var _sfc_main$z = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const identifierMode = computed(() => {
      var _a;
      return (_a = props.appInfo.allowed_identifier) != null ? _a : te.email;
    });
    function onSubmit(event) {
      return __async2(this, null, function* () {
        ...
        const beforeAuthResult = useCallbacks().beforeAuth.value(identifier2, { authType: BeforeAuthCallbackType.Login });
        if (!beforeAuthResult) {
          return;
        }
    ...
    function checkIdentifierExistsAndStatus(identifierExists, identifierType, userStatus) {
      ...
      if (identifierExists && userStatus === Y.INACTIVE) {
  ...
  setup(__props, { emit: __emit }) {
    ...
    function onSubmit(event) {
      return __async2(this, null, function* () {
        ...
        let userMetadata = void 0;
        if (metadataComponent.value) {
          userMetadata = transformMetadata(metadata.value, props.appInfo.user_metadata_schema, true);
        }
        const beforeAuthResult = useCallbacks().beforeAuth.value(identifier2, {
          userMetadata,
          authType: BeforeAuthCallbackType.Register
        });
        if (!beforeAuthResult) {
          return;
        }
        try {
          ...
          if (err instanceof u && err.message.startsWith("Public signup")) {
    ...
    return (_ctx, _cache) => {
      return showPassageRegistration.value ? (openBlock(), createElementBlock("div", _hoisted_1$v, [
        ...
        !publicSignup.value ? (openBlock(), createElementBlock("div", _hoisted_2$k, toDisplayString$1(unref(t2)("public-registration-not-allowed")), 1)) : createCommentVNode("", true)
      ])) : createCommentVNode("", true);
    };
  }
});
...
var _hoisted_2$j = { class: "passage-branding" };
var _hoisted_3$g = {
    ...
    return (_ctx, _cache) => {
      return _ctx.appInfo.passage_branding ? (openBlock(), createElementBlock("div", _hoisted_1$u, [
        createBaseVNode("div", _hoisted_2$j, [
          createBaseVNode("a", _hoisted_3$g, [
...
var _sfc_main$w = defineComponent({
  ...
  setup(__props) {
    ...
    const buttonText = computed(() => {
      return t2("continue-with-social", [t2(socialConnectionMetadata[props.connection].nameKey)]);
    });
    const buttonIconAlt = computed(() => {
      return `${t2(socialConnectionMetadata[props.connection].nameKey)} icon`;
    });
    function authorizeWith() {
      return __async2(this, null, function* () {
        try {
          ...
          const psgError = error;
          if (psgError.statusCode === g.PSGSecureContextRequired) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        "data-testid": `social-auth-button-${_ctx.connection}`
      }, [
        createVNode(unref(InlineSvg), {
        ...
        createBaseVNode("span", null, toDisplayString$1(buttonText.value), 1)
      ], 8, _hoisted_1$t);
    };
  }
});
...
var _hoisted_3$f = createBaseVNode("hr", { class: "divider-line" }, null, -1);
var _hoisted_4$f = {
  class: "divider-text",
  "data-testid": "social-auth-divider"
};
var _hoisted_5$e = createBaseVNode("hr", { class: "divider-line" }, null, -1);
var _hoisted_6$c = {
  key: 2,
  class: "spacer-tall"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        showDivider.value ? (openBlock(), createElementBlock("div", _hoisted_2$i, [
          _hoisted_3$f,
          createBaseVNode("span", _hoisted_4$f, toDisplayString$1(unref(t2)("or")), 1),
          _hoisted_5$e
        ])) : createCommentVNode("", true),
...
var _hoisted_1$q = { class: "view-email-input auth-flex-container" };
var _hoisted_2$h = { class: "auth-flex-container" };
var _hoisted_3$e = { class: "title main-title has-text-centered" };
var _hoisted_4$e = createBaseVNode("div", { style: { "height": "20px" } }, null, -1);
var _hoisted_5$d = createBaseVNode("div", { class: "spacer-tall" }, null, -1);
var _hoisted_6$b = { class: "link has-text-centered" };
var _hoisted_7$a = { key: 0 };
var _hoisted_8$8 = { key: 1 };
          ...
          createBaseVNode("div", _hoisted_6$b, [
            showLogin.value && publicSignup.value ? (openBlock(), createElementBlock("div", _hoisted_7$a, [
              ...
              createBaseVNode("a", {
                ...
                class: "body-link",
                "data-testid": "register-link"
              }, toDisplayString$1(unref(t2)("register-here")), 1)
            ])) : !showLogin.value ? (openBlock(), createElementBlock("div", _hoisted_8$8, [
              ...
              }, toDisplayString$1(unref(t2)("login-here")), 1)
            ])) : createCommentVNode("", true)
          ])
        ]),
...
var _hoisted_1$p = { class: "auth-flex-container" };
var _hoisted_2$g = {
...
var _hoisted_3$d = {
  ...
  "data-testid": "activate-magic-link-message",
  style: { "margin-top": "8px", "margin-bottom": "40px" }
};
var _hoisted_4$d = { key: 0 };
var _hoisted_5$c = { key: 1 };
        ...
        default: withCtx(() => [
          withDirectives(createBaseVNode("div", _hoisted_1$p, [
            ...
            createBaseVNode("div", _hoisted_3$d, [
              unref(showSuccess) && unref(magicLinkAction) === unref(MagicLinkActionEnum).LOGIN ? (openBlock(), createElementBlock("div", _hoisted_4$d, toDisplayString$1(unref(t2)("successfully-logged-in-redirect")), 1)) : unref(showSuccess) && unref(magicLinkAction) === unref(MagicLinkActionEnum).VERIFY ? (openBlock(), createElementBlock("div", _hoisted_5$c, toDisplayString$1(unref(t2)("successfully-changed-email")), 1)) : unref(showFailure) && unref(invalidMagicLink) && unref(magicLinkAction) === unref(MagicLinkActionEnum).VERIFY ? (openBlock(), createElementBlock("div", _hoisted_6$a, toDisplayString$1(unref(t2)("link-invalid")), 1)) : unref(showFailure) && unref(invalidMagicLink) ? (openBlock(), createElementBlock("div", _hoisted_7$9, toDisplayString$1(unref(t2)("login-link-invalid")), 1)) : unref(showFailure) && unref(magicLinkAction) === unref(MagicLinkActionEnum).VERIFY ? (openBlock(), createElementBlock("div", _hoisted_8$7, toDisplayString$1(unref(t2)("verification-failed-please-try-again")), 1)) : createCommentVNode("", true)
            ]),
            unref(showFailure) || unref(showSuccess) ? (openBlock(), createElementBlock("div", _hoisted_9$4, [
              createBaseVNode("button", {
                ...
                "data-testid": "activate-magic-link-button"
              }, [
...
var _hoisted_1$o = { class: "view-verify-token" };
...
var _hoisted_1$n = { class: "view-email-input" };
...
var _hoisted_1$l = { class: "spinner-box" };
var _hoisted_2$f = { class: "spinner-content" };
...
var Spinner = _export_sfc(_sfc_main$o, [["render", _sfc_render3]]);
var _hoisted_1$k = { class: "auth-flex-container" };
var _hoisted_2$e = { class: "title has-text-centered" };
var _hoisted_3$c = {
  key: 0,
  class: "content has-text-centered",
  style: { "margin-bottom": "40px !important" }
};
var _hoisted_4$c = ["innerHTML"];
var _hoisted_5$b = { class: "flex-row flex-center" };
...
var _sfc_main$n = defineComponent({
  ...
  setup(__props) {
    ...
    function delay(i2) {
      lookupMagicLink();
      localStorage.setItem("wait_count", i2.toString());
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$k, [
        ...
        createBaseVNode("div", _hoisted_5$b, [
          ...
          }, toDisplayString$1(unref(t2)("resend-isemail-email-message", [isEmail2.value ? unref(t2)("email") : unref(t2)("message")])), 9, _hoisted_6$9)
        ]),
        _hoisted_7$8,
        createBaseVNode("div", _hoisted_8$6, [
          ...
          }, toDisplayString$1(unref(t2)("change-isemail-email-phone", [isEmail2.value ? unref(t2)("email") : unref(t2)("phone")])), 1)
        ])
      ]);
    };
  }
});
var _hoisted_1$j = { class: "view-access-token auth-flex-container" };
...
var _hoisted_1$i = { class: "passage-learnmore-modal" };
var _hoisted_2$d = { class: "passage-learnmore-top" };
var _hoisted_3$b = { class: "passage-learnmore-close-button" };
var _hoisted_4$b = { class: "passage-learnmore-content" };
var _hoisted_5$a = { style: { "margin-bottom": "32px" } };
...
var _hoisted_1$h = { style: { "margin-bottom": "12px" } };
var _hoisted_2$c = { class: "passage-learnmore-header" };
var _hoisted_3$a = { class: "passage-learnmore-body" };
var _hoisted_4$a = { class: "passage-learnmore-header" };
var _hoisted_5$9 = { class: "passage-learnmore-body" };
var _hoisted_6$8 = { class: "passage-learnmore-header" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$l, null, {
        cta: withCtx(() => [
          createBaseVNode("div", _hoisted_1$h, toDisplayString$1(unref(t2)("passkeys-are-a-simple")), 1),
        ...
        body: withCtx(() => [
          ...
          createBaseVNode("div", _hoisted_5$9, toDisplayString$1(unref(t2)("passkey-is-unique")), 1),
...
var _hoisted_17$1 = createBaseVNode("div", { class: "spacer" }, null, -1);
var _hoisted_18$1 = {
  key: 4,
  class: "content has-text-centered",
...
var _sfc_main$j = defineComponent({
  ...
  setup(__props) {
    ...
    let previousAttachment = T.Platform;
    ...
    function primaryRegister() {
      if (supportsPlatform.value === true) {
        signUpWebAuthn(props.identifier, T.Platform);
      } else {
        signUpWebAuthn(props.identifier, T.CrossPlatform);
      }
    }
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$g, [
        createBaseVNode("div", _hoisted_2$b, toDisplayString$1(supportsPlatform.value ? unref(t2)("register-with-a-passkey") : unref(t2)("register-passkey-another-device")), 1),
        ...
        showFailure.value ? (openBlock(), createElementBlock("div", _hoisted_4$9, [
          ...
          !supportsPlatform.value && supportsCrossPlatform.value ? (openBlock(), createElementBlock("div", _hoisted_9$3, [
        ...
        showFailure.value ? (openBlock(), createElementBlock("div", _hoisted_11$3, [
          ...
          createBaseVNode("button", {
            ...
            part: "button",
            disabled: loading.value,
            "data-testid": "register-main-button",
            tabindex: "0",
            ref_key: "autofocusButton",
            ref: autofocusButton,
          ...
          supportsPlatform.value && supportsCrossPlatform.value ? (openBlock(), createElementBlock("button", {
            ...
            disabled: loading.value,
            "data-testid": "register-secondary-button",
            tabindex: "0",
            ref_key: "autofocusButton",
            ref: autofocusButton
          }, [
        ...
        !showFailure.value ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_20$1, [
            createBaseVNode("a", {
              ...
              role: "button",
              "data-testid": "change-email-button"
            }, toDisplayString$1(unref(t2)("back")), 1)
          ]),
          supportsFallback.value ? (openBlock(), createElementBlock("div", _hoisted_21$1, [
            createBaseVNode("a", {
              onClick: withModifiers(registerWithFallback, ["prevent"]),
              role: "button",
              "data-testid": "register-email-button"
            }, toDisplayString$1(fallbackRegisterWithCodeEmailOrTextBtnCopy.value), 1)
          ])) : createCommentVNode("", true)
...
var _hoisted_1$f = { class: "auth-flex-container" };
var _hoisted_2$a = { class: "title has-text-centered" };
var _hoisted_3$8 = {
  class: "image has-text-centered",
...
var _hoisted_5$7 = { "data-testid": "failure-message" };
var _hoisted_6$6 = { style: { "margin": "0px", "margin-top": "8px", "margin-bottom": "40px" } };
var _hoisted_7$5 = {
  key: 2,
  class: "flex-row flex-center"
};
  ...
  setup(__props) {
    ...
    function signInWebAuthn() {
      return __async2(this, null, function* () {
        ...
        try {
          ...
          showFailure.value = true;
          loading.value = false;
          if (error.statusCode === g.PSGParsePublicKeyForLoginFailed) {
            showFailure.value = true;
          } else {
            emitEvent2({
              type: AuthEventType.EmailOrSMSAuth,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$f, [
        createBaseVNode("div", _hoisted_2$a, toDisplayString$1(title.value), 1),
        ...
        !showFailure.value ? (openBlock(), createBlock(_sfc_main$k, {
          ...
          createBaseVNode("div", _hoisted_5$7, [
            createBaseVNode("p", _hoisted_6$6, toDisplayString$1(failureLoginText.value), 1)
          ])
        ])) : createCommentVNode("", true),
        showFailure.value ? (openBlock(), createElementBlock("div", _hoisted_7$5, [
          createBaseVNode("button", {
            ...
            disabled: loading.value,
            style: { "margin-right": "5px" }
          }, toDisplayString$1(unref(t2)("try-again")), 9, _hoisted_8$4),
          supportsFallback.value ? (openBlock(), createElementBlock("button", {
            key: 0,
            ...
            ref_key: "autofocusButton",
            ref: autofocusButton
          }, toDisplayString$1(fallbackSendCodeEmailOrTextBtnCopy.value), 9, _hoisted_9$2)) : createCommentVNode("", true)
        ])) : createCommentVNode("", true),
        _hoisted_10$2,
        ...
        !showFailure.value ? (openBlock(), createElementBlock("div", {
          ...
          supportsFallback.value ? (openBlock(), createElementBlock("div", _hoisted_14$2, [
            createBaseVNode("a", {
              onClick: withModifiers(loginWithFallback, ["prevent"]),
              role: "button",
              "data-testid": "register-email-button"
            }, toDisplayString$1(loginWithCodeEmailOrTextBtnCopy.value), 1)
          ])) : createCommentVNode("", true)
        ], 2)) : createCommentVNode("", true)
      ]);
    };
...
var _hoisted_1$e = { class: "view-webauthn-sign-in auth-flex-container" };
...
var _hoisted_2$9 = ["data-testid", "type", "inputtype", "placeholder", "inputmode", "disabled", "maxlength", "autocomplete"];
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$d, [
        withDirectives(createBaseVNode("input", {
          "data-testid": `otp-single-input-${_ctx.inputIdx}`,
...
var _sfc_main$e = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const handleOnPaste = (event) => {
      ...
      combinedWithPastedData.slice(0, props.numInputs).forEach((value, i2) => {
        otp.value[i2] = value;
      });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$c, [
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.numInputs, (_, i2) => {
          return openBlock(), createBlock(_sfc_main$f, {
            key: i2,
            focus: activeInput.value === i2,
            value: otp.value[i2],
            separator: _ctx.separator,
            "input-type": _ctx.inputType,
            inputmode: _ctx.inputmode,
            "input-classes": _ctx.inputClasses,
            conditionalClass: _ctx.conditionalClass[i2],
            "is-last-child": i2 === _ctx.numInputs - 1,
            "is-first-child": i2 === 0,
            "should-auto-focus": _ctx.shouldAutoFocus,
            placeholder: _ctx.placeholder[i2],
            "is-disabled": _ctx.isDisabled || _ctx.disableNonCurrent && i2 > otp.value.join("").trim().length,
            "input-idx": i2,
            "input-count": _ctx.numInputs,
            onOnChange: handleOnChange,
            onOnKeydown: handleOnKeyDown,
            onOnPaste: handleOnPaste,
            onOnFocus: ($event) => handleOnFocus(i2),
...
var _hoisted_4$6 = { class: "content wrap-text" };
var _hoisted_5$6 = { style: { "margin-top": "32px", "margin-bottom": "40px" } };
  ...
  setup(__props) {
    ...
    const activateOneTimePasscode = () => __async2(this, null, function* () {
      ...
      try {
        ...
        if (passageError.statusCode === g.Unauthorized) {
          setError(t2("otp-limit-error"));
        } else {
          setError(t2("code-invalid-or-expired"));
        }
      } finally {
        loading.value = false;
      }
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$b, [
        createBaseVNode("form", _hoisted_2$7, [
          ...
          createBaseVNode("div", _hoisted_8$3, [
            createBaseVNode("div", _hoisted_9$1, toDisplayString$1(errorMessage.value ? errorMessage.value : " "), 1)
          ]),
          ...
          createBaseVNode("div", _hoisted_13$1, [
            createBaseVNode("div", _hoisted_14$1, [
              createBaseVNode("a", {
                ...
                role: "button",
                "data-testid": "one-time-passcode-goback-button"
              }, toDisplayString$1(btnGoBackText.value), 1)
            ]),
            createBaseVNode("div", _hoisted_15$1, [
              createBaseVNode("a", {
                onClick: withModifiers(onResendCodeClicked, ["prevent"]),
                role: "button",
                "data-testid": "one-time-passcode-resend-button"
              }, toDisplayString$1(btnResendText.value), 1)
            ])
          ])
        ])
      ]);
...
var _hoisted_1$a = { class: "view-access-token auth-flex-container" };
...
var _sfc_main$b = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1$9, toDisplayString$1(title.value), 1),
        createBaseVNode("figure", _hoisted_2$62, [
        ...
        showFailure.value ? (openBlock(), createElementBlock("div", _hoisted_3$52, toDisplayString$1(unref(t2)("failed-to-add-this-device")), 1)) : (openBlock(), createBlock(_sfc_main$k, {
          key: 1,
          cta: unref(t2)("log-into-your-account")
        }, null, 8, ["cta"])),
        createBaseVNode("div", _hoisted_4$5, [
          createBaseVNode("button", {
            ...
            showFailure.value ? (openBlock(), createElementBlock("span", _hoisted_6$4, toDisplayString$1(unref(t2)("try-again")), 1)) : (openBlock(), createElementBlock("span", _hoisted_7$3, toDisplayString$1(unref(t2)("add-passkey")), 1))
          ], 10, _hoisted_5$5)
        ]),
        !showSuccess.value ? (openBlock(), createElementBlock("div", _hoisted_8$2, [
          createBaseVNode("div", null, [
            createBaseVNode("a", {
              ...
              role: "button",
              "data-testid": "add-device-skip"
            }, toDisplayString$1(unref(t2)("skip")), 1)
          ])
        ])) : createCommentVNode("", true)
      ], 64);
    };
...
var _hoisted_1$8 = { class: "view-add-device" };
var _sfc_main$a = defineComponent({
...
var _hoisted_2$52 = { class: "passage-learnmore-header" };
var _hoisted_3$42 = { class: "passage-learnmore-body" };
var _hoisted_4$42 = { class: "passage-learnmore-header" };
var _hoisted_5$42 = { class: "passage-learnmore-body" };
var _sfc_main$9 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$l, null, {
        cta: withCtx(() => [
          createBaseVNode("div", _hoisted_1$72, toDisplayString$1(unref(t2)("passkeys-are-required")) + toDisplayString$1(" "), 1),
          createTextVNode(" " + toDisplayString$1(unref(t2)("try-again-on-device-with-passkeys")), 1)
        ]),
        body: withCtx(() => [
          createBaseVNode("div", _hoisted_2$52, toDisplayString$1(unref(t2)("what-are-passkeys")), 1),
          createBaseVNode("div", _hoisted_3$42, toDisplayString$1(unref(t2)("passkeys-are-a-simpler-and-more-secure-alternative")), 1),
          createBaseVNode("div", _hoisted_4$42, toDisplayString$1(unref(t2)("devices-that-support-passkeys")), 1),
          createBaseVNode("div", _hoisted_5$42, toDisplayString$1(unref(t2)("devices-with-a-biometric-sensor-are-likely-to-support-passkeys")), 1)
        ]),
        _: 1
      });
    };
...
var _hoisted_1$62 = { class: "auth-flex-container" };
var _hoisted_2$42 = { class: "title has-text-centered" };
var _hoisted_3$32 = { class: "image has-text-centered" };
var _hoisted_4$32 = createBaseVNode("div", { class: "spacer" }, null, -1);
var _hoisted_5$32 = { class: "flex-row flex-wrap flex-center" };
var _hoisted_6$3 = { class: "link" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$62, [
        createBaseVNode("div", _hoisted_2$42, toDisplayString$1(unref(t2)("device-not-supported")), 1),
        ...
        _hoisted_4$32,
        createBaseVNode("div", _hoisted_5$32, [
...
var _hoisted_1$52 = { class: "auth-flex-container" };
var _hoisted_2$32 = { class: "title has-text-centered" };
var _hoisted_3$22 = { class: "image has-text-centered" };
var _hoisted_4$22 = {
  class: "wrap-text",
  style: { "margin-bottom": "12px !important" }
};
var _hoisted_5$22 = { class: "wrap-text" };
var _hoisted_6$2 = createBaseVNode("div", { class: "spacer" }, null, -1);
var _hoisted_7$2 = { class: "flex-row flex-wrap flex-center" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$52, [
        createBaseVNode("div", _hoisted_2$32, toDisplayString$1(unref(t2)("login-not-supported")), 1),
        ...
        createBaseVNode("div", _hoisted_4$22, toDisplayString$1(unref(t2)("passkeys-are-now-required")), 1),
        createBaseVNode("div", _hoisted_5$22, toDisplayString$1(unref(t2)("please-contact-support-to-regain-access")), 1),
        _hoisted_6$2,
...
var _hoisted_1$42 = { class: "auth-flex-container flex-center" };
var _hoisted_2$22 = { class: "title has-text-centered" };
var _hoisted_3$12 = {
  class: "flex-column flex-center",
  style: { "margin-bottom": "32px" }
};
var _hoisted_4$12 = { key: 2 };
var _hoisted_5$12 = { style: { "margin-bottom": "40px" } };
...
var _sfc_main$42 = defineComponent({
  ...
  setup(__props) {
    ...
    const title = computed(() => {
      if (showError.value) {
        return t2("link-account-failed");
      }
      return t2("link-your-account-to-social-provider", [t2(connection != null ? connection : "")]);
    });
    const buttonIconAlt = computed(() => {
      return `${t2(metadata.nameKey)} icon`;
    });
    const message = computed(() => {
      if (showError.value) {
        return t2("session-invalid");
      }
      return t2("found-existing-account", [t2(connection != null ? connection : "")]);
    });
    const icon = computed(() => {
      switch (theme.value) {
        case Theme.Dark:
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("form", _hoisted_1$42, [
        ...
        createBaseVNode("div", _hoisted_3$12, [
          ...
          !showError.value ? (openBlock(), createElementBlock("div", _hoisted_4$12, [
            createBaseVNode("strong", null, toDisplayString$1(_ctx.identifier), 1)
          ])) : createCommentVNode("", true)
        ]),
        createBaseVNode("div", _hoisted_5$12, toDisplayString$1(message.value), 1),
        !showError.value ? (openBlock(), createElementBlock("button", {
          key: 0,
          class: "button is-primary",
          onClick: withModifiers(linkAccount, ["prevent"])
        }, toDisplayString$1(unref(t2)("link-account")), 1)) : (openBlock(), createElementBlock("button", {
          key: 1,
          class: "button is-primary",
          onClick: withModifiers(cancel, ["prevent"])
        }, toDisplayString$1(unref(t2)("return-to-login")), 1)),
        _hoisted_6$1,
        !showError.value ? (openBlock(), createElementBlock("div", _hoisted_7$1, [
          createBaseVNode("a", {
            onClick: withModifiers(cancel, ["prevent"]),
            role: "button"
          }, toDisplayString$1(unref(t2)("cancel")), 1)
        ])) : createCommentVNode("", true)
      ]);
    };
  }
});
var _hoisted_1$32 = { class: "link-account auth-flex-container" };
...
var _hoisted_32 = createBaseVNode("div", { class: "section-label" }, "Props", -1);
...
var _hoisted_10 = createBaseVNode("div", { class: "control-label" }, "User Is Verifying", -1);
var _hoisted_11 = { key: 2 };
var _hoisted_122 = createBaseVNode("div", { class: "control-label" }, "Identifier", -1);
var _hoisted_13 = createBaseVNode("div", { class: "control-label" }, "Identifier Type", -1);
var _hoisted_14 = createBaseVNode("div", { class: "control-label" }, "Setup New Device", -1);
var _hoisted_15 = createBaseVNode("div", { class: "control-label" }, "User Is Registering", -1);
var _hoisted_16 = createBaseVNode("div", { class: "control-label" }, "Verifying Identifier", -1);
var _hoisted_17 = { key: 3 };
var _hoisted_18 = createBaseVNode("div", { class: "control-label" }, "Identifier", -1);
var _hoisted_19 = createBaseVNode("div", { class: "control-label" }, "Identifier Type", -1);
var _hoisted_20 = createBaseVNode("div", { class: "control-label" }, "Setup New Device", -1);
var _hoisted_21 = createBaseVNode("div", { class: "control-label" }, "User Is Registering", -1);
var _hoisted_222 = createBaseVNode("div", { class: "control-label" }, "Verifying Identifier", -1);
var _hoisted_23 = { key: 4 };
var _hoisted_24 = createBaseVNode("div", { class: "control-label" }, "Identifier", -1);
var _hoisted_25 = createBaseVNode("div", { class: "control-label" }, "Social Connection", -1);
var _hoisted_26 = createBaseVNode("div", { class: "control-label" }, "Code", -1);
var _hoisted_27 = { key: 5 };
var _hoisted_28 = createBaseVNode("div", { class: "control-label" }, "Magic Link", -1);
var _hoisted_29 = { key: 6 };
...
var _sfc_main$22 = defineComponent({
  ...
  setup(__props) {
    ...
    const linkAccountConnection = ref(ne.Google);
...
var _hoisted_210 = { class: "debug-panel-body" };
...
var _hoisted_111 = { class: "auth-flex-container" };
var _sfc_main4 = defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const { languageLoading, containerRef, currentTheme } = useElementSetup(props);
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        id: "passage-auth-container",
        class: normalizeClass(["passage-auth", unref(currentTheme)]),
        ref_key: "containerRef",
        ref: containerRef
      }, [
        withDirectives(createBaseVNode("div", _hoisted_111, [
          (openBlock(), createBlock(_sfc_main3, {
            key: _ctx.appId,
            ...
            _: 3
          }, 8, ["homeRoute", "authContainerRef", "theme"]))
        ], 512), [
...
function registerPassageAuthElement() {
  safelyRegisterElement(_sfc_main4, "auth");
}
